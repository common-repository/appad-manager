	...
	<form name="mainform" method="post" action="">
		...
		<div id="tabs-wrap" class="">
			<ul class="tabs">
				...
				<li class=""><a href="#tab2"><?php _e( 'Between coupons', APPAD_TD ); ?></a></li>
			</ul>
			...
			<div id="tab2" class="">
				<table class="widefat fixed" style="width:850px; margin-bottom:20px;">
					<thead>
						<tr>
							<th width="200px" scope="col"><?php _e( 'Ads between coupons', APPAD_TD ); ?></th>
							<th scope="col">&nbsp;</th>
						</tr>
					</thead>
					<tbody>
...
<?php
	...
	printf( __( 'Sorry, You are not using %s Theme, so You can not access this page.', APPAD_TD ), 'Clipper' );
	printf( __( ' <a target="_blank" href="%s">Buy it now!</a>', APPAD_TD ), 'http://bit.ly/oLSh2D' );
	echo '</div>';
endif; //app_theme
